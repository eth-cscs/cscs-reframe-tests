    ...
    'modes': [
        {
            ...
            'options': [
                ...
                '--exec-policy=async',
                '-Sstrict_check=1',
                '--output=$SCRATCH/regression/$USER/maintenance',
                '--perflogdir=$SCRATCH/regression/$USER/maintenance/logs',
                '--stage=$SCRATCH/regression/maintenance/stage',
                '--report-file=$SCRATCH/regression/$USER/maintenance/reports/maint_report_{sessionid}.json',
