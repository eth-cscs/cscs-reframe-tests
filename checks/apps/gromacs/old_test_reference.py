# Old tests here for reference. 
# TODO Need to parameterize the current tests for different architectures, problem types (functionality test) and also add PLUMED tests
