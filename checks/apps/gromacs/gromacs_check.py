    ...
    allref = {
        ...
        6: {
            'sm_60': {
                ...
                'HECBioSim/hEGFRDimerSmallerPL': (29.346, None, -0.10, 'ns/day'),
                'HECBioSim/hEGFRDimerPair': (13.0, None, None, 'ns/day'),
        ...
        16: {
            'sm_60': {
                ...
                'HECBioSim/hEGFRDimerSmallerPL': (41.889, None, -0.10, 'ns/day'),
            ...
            'broadwell': {
                ...
                'HECBioSim/hEGFRDimerSmallerPL': (31.47, None, -0.10, 'ns/day'),
