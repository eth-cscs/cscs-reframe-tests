...
cp2k_references = {
    'md': {
        'gh200': {'time_run': xfail("Nvidia 590+ regression", (45, None, 0.05, 's'))},
        'zen2': {'time_run': (94, None, 0.05, 's')}
    },
    'pbe': {
        'gh200': {'time_run': xfail("Nvidia 590+ regression", (51, None, 0.05, 's'))},
        'zen2': {'time_run': (75, None, 0.05, 's')}
    },
    'rpa': {
        'gh200': {'time_run': xfail("Nvidia 590+ regression", (575, None, 0.05, 's'))}
    },
}
